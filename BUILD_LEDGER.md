...
| 08 | Market experiment kit | `mission-08/EXPERIMENT_README.md` | Defines the offer, listing copy, intake, safety bounds, and measurement rules | Yes — exposed as a manual service offer | No | LIVE on r/CreatorServices |
...
Mission 10 changed the distribution state of Experiment #002 only. Current counters remain: customer-facing apps **0**, dashboards **0**, software products **0**, and verified autonomous agents **0**. Market experiments prepared: **2**. Market experiments live: **1**.
